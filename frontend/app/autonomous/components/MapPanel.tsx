      ...
      <div className="flex h-full flex-col space-y-4">
        <div>
          ...
          {mapMode === "navigate" ? (
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              {hasPendingPlacement ? (
                <button
                  ...
                  className="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-xs font-semibold text-[var(--foreground)]"
                >
                  Cancel placing
                </button>
              ) : null}
            ...
            <div className="mb-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-xs text-[var(--muted)]">
              View mode: chỉ xem robot, path, grid, goal, scan, saved points.
            </div>
          )}
