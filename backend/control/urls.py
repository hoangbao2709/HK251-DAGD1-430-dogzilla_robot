...
urlpatterns = [
    ...
    path("api/robots/<str:robot_id>/slam/goal/", GoalPoseView.as_view(), name="robot-slam-goal"),
    path("api/robots/<str:robot_id>/slam/initial-pose/", InitialPoseView.as_view(), name="robot-slam-initial-pose"),
    path("api/robots/<str:robot_id>/slam/save-map/", SaveSlamMapView.as_view(), name="robot-slam-save-map"),
    path("api/robots/<str:robot_id>/slam/upload-map/", UploadSlamMapView.as_view(), name="robot-slam-upload-map"),
    path("api/robots/<str:robot_id>/slam/use-live-map/", UseLiveSlamMapView.as_view(), name="robot-slam-use-live-map"),
    path("api/robots/<str:robot_id>/slam/maps/<str:filename>", SlamMapFileView.as_view(), name="robot-slam-map-file"),
